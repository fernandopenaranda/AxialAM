...
mu = parse(Float64, ARGS[18])
t1 = parse(Float64, ARGS[19])
t2 = parse(Float64, ARGS[20])
t4 = parse(Float64, ARGS[21])
tperp = parse(Float64, ARGS[22])
Deltasz = parse(Float64, ARGS[23])
Deltatauz = parse(Float64, ARGS[24])
neel1 = parse(Float64, ARGS[25])
neel2 = parse(Float64, ARGS[26])
neel3 = parse(Float64, ARGS[27])
mumin = parse(Float64, ARGS[28])
mumax = parse(Float64, ARGS[29])
mupoints= parse(Int, ARGS[30])
...
p = AM_presets_3d(am_presets_3d() , a0 =a0,  t1 = t1, t4 = t4, t2 = t2, 
    tperp = tperp, Δsz = Deltasz, Δtz = Deltatz, neel = [neel[1], neel[2], neel[3]])
